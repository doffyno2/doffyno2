...
<!-- XML Sitemap generated by NodeJs -->`);
    ...
    } else if (req.url=="/6f51de8449bf4827a55723ccdf27ab47.txt" && req.method === "GET") {
    //------- robots.txt --------------
      let data = await getFile('6f51de8449bf4827a55723ccdf27ab47.txt');
      res.writeHead(200, {
        "content-type": "text/plain; charset=UTF-8"
      });
      res.end(data);
    } else if (req.url=="/a0132d57e82f425d804a6985a97dfa81.txt" && req.method === "GET") {
    //------- robots.txt --------------
      let data = await getFile('a0132d57e82f425d804a6985a97dfa81.txt');
      res.writeHead(200, {
        "content-type": "text/plain; charset=UTF-8"
      });
      res.end(data);
    } else if (req.url=="/2361470cb25c4fdda774a8b6238c618d.txt" && req.method === "GET") {
    //------- robots.txt --------------
      let data = await getFile('2361470cb25c4fdda774a8b6238c618d.txt');
      res.writeHead(200, {
        "content-type": "text/plain; charset=UTF-8"
      });
      res.end(data);
